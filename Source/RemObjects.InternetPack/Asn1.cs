...
namespace RemObjects.InternetPack.Ldap
{
    ...
    class BerInteger : BerValue
    {
        ...
        public override Int32 Length
        {
            get
            {
                if (this.fValue < 0)
                {
                    ...
                    if (this.fValue >= -32768)
                        return 2;

                    if (this.fValue >= -8388608)
                        return 3;
        ...
        {
            this.fValue = Asn1.DecodeInt(reader, length);
        }
        ...
        protected override void IntWrite(BinaryWriter writer)
        {
            if (this.fValue < 0)
            {
                if (this.fValue >= -128)
                {
                    writer.Write((Byte)this.fValue);
                }
                else if (this.fValue >= -32768)
                {
                    UInt16 lValue = (UInt16)this.fValue;
                    writer.Write((Byte)(lValue >> 8));
                    writer.Write((Byte)(lValue));
                }
                else if (fValue >= -8388608)
                {
                    UInt32 lValue = (UInt32)this.fValue;
            ...
            else
            {
                ...
                {
                    UInt16 newval = (UInt16)fValue;
                    writer.Write((Byte)(newval >> 8));
                    writer.Write((Byte)(newval));
                }
                else if (this.fValue < 8388608)
                {
                    UInt32 lValue = (UInt32)this.fValue;
                    writer.Write((Byte)(lValue >> 16));
                    writer.Write((Byte)(lValue >> 8));
    ...
    class BerUInteger : BerValue
    {
        ...
        {
            this.fTypeTag = code;
            this.fValue = Asn1.DecodeUInt(reader, length);
        }
        ...
        protected override void IntWrite(BinaryWriter writer)
        {
            ...
            else if (this.fValue < 65536)
            {
                writer.Write((Byte)(this.fValue >> 8));
                writer.Write((Byte)this.fValue);
            }
            else if (this.fValue < 16777216)
            {
                writer.Write((Byte)(this.fValue >> 16));
                writer.Write((Byte)(this.fValue >> 8));
                writer.Write((Byte)this.fValue);
            }
            else
            {
                writer.Write((Byte)(this.fValue >> 24));
                writer.Write((Byte)(this.fValue >> 16));
                writer.Write((Byte)(this.fValue >> 8));
                writer.Write((Byte)this.fValue);
            }
        ...
        public override Int32 Length
        {
            get
            {
                ...
                if (this.fValue < 65536)
                    return 2;

                if (this.fValue < 16777216)
                    return 3;
        ...
        public override Byte TypeTag
        {
            get
            {
                return this.fTypeTag;
            }
        }

        public Byte TypeCodeTag
        {
            get
            {
                return this.fTypeTag;
    ...
    class BerBinary : BerValue
    {
        ...
        protected override void IntRead(BinaryReader reader, Byte code, Int32 length)
        {
            this.fValue = reader.ReadBytes(length);
        }
    ...
    class BerString : BerValue
    {
        public BerString()
        {
            this.fTypeTag = Asn1.OCTETSTRING;
        }
        ...
        public override Int32 Length
        {
            get
            {
                return this.fValue == null ? 0 : Encoding.UTF8.GetByteCount(this.fValue);
            }
        }
        ...
        {
            if (this.fValue != null)
                writer.Write(Encoding.UTF8.GetBytes(this.fValue));
        }
        ...
        protected override void IntRead(BinaryReader reader, Byte code, Int32 length)
        {
            ...
            this.fValue = Encoding.UTF8.GetString(lValue, 0, lValue.Length);
        }
