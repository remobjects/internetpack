...
namespace FtpSync
{
	public class FtpSyncWorker
	{
		...
		private bool fDoNotDeleteMissingItems;
		private bool fRecursiveSync;
		private bool fPassiveMode;
		private bool fDoShowFtpClientLog;
		...
		public void Sync()
		{
			try
			{
				...
				fFtpClient.OnLog += ServerLog;
				fFtpClient.OnTransferProgress += Ftp_OnTransferProgress;
