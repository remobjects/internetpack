...
namespace HTTPSpy
{
	public class MainForm : System.Windows.Forms.Form
	{
		...
		{
			DataRow newRow = this.tblHeaders.NewRow();
			newRow["Name"] = name;
			newRow["Value"] = value;

			this.tblHeaders.Rows.Add(newRow);
		}

		private void AddResponseHeader(string name, string value)
		{
			DataRow newRow = this.tblResponseHeaders.NewRow();
			newRow["Name"] = name;
			newRow["Value"] = value;

			this.tblResponseHeaders.Rows.Add(newRow);
		}
		...
		private void ShowResponse(HttpClientResponse aResponse)
		{
